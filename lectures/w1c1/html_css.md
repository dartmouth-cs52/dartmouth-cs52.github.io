...
HTML uses **tags** to describe structure.  Tags are designated by `< >` surrounding the tag.
...
Most browsers happen to grant certain structural elements with default styles.  For instance I can put in `

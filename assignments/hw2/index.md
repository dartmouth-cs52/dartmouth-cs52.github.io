...
## Server Side Rendering with Node and Express

Where we build a simple server side rendered interactive site.
...
We will use templating to generate some pages from some data.


### Part 2

We'll add Facebook Authentication!


## Let's Start

🚀  Clone this repo:  node+babel+eslint

```bash
# also don't forget to run:
npm install #to install dependent packages from package.json
```
...
We want to create a petition site. //TODO: fill in more
...
* Petition App:
  ...
  * Delete a petition (as admin)

### Plan

//TODO: come up with plan

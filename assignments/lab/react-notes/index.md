...
Wait, but where do the unique note `id`s come from?  Eventually they'll be generated by Firebase, but for now let's generate something called a globally unique id:
